...
public interface TransactionalUncheckedOutputStream
  extends VUWriter, IOTransactional
{
    ...
    */
    ...
    /**
      The close method is defined to invoke the abort method. This behavior allows a transactional output stram to be
